                ...
                <section>
                    ...
                    <div className='h-[100vh] flex items-center justify-center'>
                        <div className='text-center w-4/5'>
                            ...
                            <p className='text-[20px]' style={{ lineHeight: "145%" }}>
                                I build digital products, brands, and create awesome experience. Welcome to my space
                            </p>
                    ...
                    <div>
                        ...
                        <div className='flex justify-between'>
                            <p className='w-2/3 text-[34px] hover:text-white transition ease-in '>
                                ...
                                forgetting about usability. I am a software developer
                                designer working with agencies and startups worldwide
                                to tackle complex projects. Having collaborated with
                                clients, Israel Chidera knows what it's like to create, design and
                                develop complex user interfaces.
                            </p>
                    ...
                    <div className='mt-20 mb-20'>
                        ...
                        <div className='space-y-10'>
                            <div className='rounded-2xl border border-tertiary px-6 py-6'>
                                ...
                                <div className='mt-2 text-sm'>
                                    <ul className='flex items-center space-x-4'>
                                        <li className='underline'>Role</li>
                            ...
                            <div className='rounded-2xl border border-tertiary px-6 py-6'>
                                <div className='grid grid-cols-4 gap-x-4 '>
                                    ...
                                    <div className='flex space-x-3 items-center justify-end'>
                                        <svg fill="#fff" className='w-6 hover:text-red-600 cursor-pointer' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
