...
const Footer = () => {
    return (
        <footer className=" xl:h-[10vh] fixed bottom-0 left-0 w-full bg-primary">
            <Container className="py-3">
                <div className="flex justify-between space-x-4 items-center">
                    <div>
                        <Drawer>
                            <DrawerTrigger>
                                <div className=' text-white text-sm uppercase flex items-center space-x-1'>
                                    <svg className=' w-4 h-4' fill='#fff' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM64 256c0-17.7 14.3-32 32-32H480c17.7 0 32 14.3 32 32s-14.3 32-32 32H96c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z" /></svg>
                                    <span>Open Menu</span>
                                </div>
                            </DrawerTrigger>
                                ...
                                <DrawerFooter>
                                    <div className="flex px-6 pt-2 justify-between">
                                        <div className="flex space-x-5 items-center">
                                            ...
                                            {/* linkedin */}
                                            <a href="https://www.linkedin.com/in/israel-chidera-97bbab89/">
                                                <svg
                                            ...
                                            {/* github */}
                                            <a href="https://github.com/IsraelChidera">
                                                <svg
                                                    className="w-[15px] h-[15x] hover:opacity-70 opacity-100 cursor-pointer"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 496 512"
                                        ...
                                        <div className='lg:block hidden'>
                                            <DrawerClose>
                                                <Button variant="outline" className='flex items-center uppercase text-sm space-x-3'>
                                                    <span>Close</span>
                                                </Button>
                                            </DrawerClose>
                                        </div>
                    ...
                    <h2 className="text-center text-white text-sm">Israel Chidera</h2>
